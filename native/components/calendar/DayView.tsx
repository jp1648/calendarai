...
function SwipeableDeleteAction() {
  return (
...
export default function DayView({
  ...
  const handleSwipeDelete = (event: CalendarEvent) => {
            ...
            {events.map((event, index) => {
              ...
              return (
                ...
                >
                  {onDeleteEvent ? (
                    <Swipeable
                      renderRightActions={() => <SwipeableDeleteAction />}
                      onSwipeableOpen={() => handleSwipeDelete(event)}
                      rightThreshold={80}
                    >
