  ...
  return (
    <>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <TextInput style={styles.input} value={title} onChangeText={setTitle} placeholder="Event title" placeholderTextColor={EARTHY.stoneLight} />

        <Text style={styles.label}>Description</Text>
        <TextInput style={[styles.input, styles.multiline]} value={description} onChangeText={setDescription} placeholder="Optional description" multiline placeholderTextColor={EARTHY.stoneLight} />

        <Text style={styles.label}>Location</Text>
        <TextInput style={styles.input} value={location} onChangeText={setLocation} placeholder="Optional location" placeholderTextColor={EARTHY.stoneLight} />
      ...
      <DatePickerModal visible={datePickerOpen} value={date ? parseISO(date) : new Date()} onSelect={(d) => setDate(format(d, "yyyy-MM-dd"))} onClose={() => setDatePickerOpen(false)} />
      <TimePickerModal visible={startPickerOpen} value={startTime || "09:00"} onSelect={setStartTime} onClose={() => setStartPickerOpen(false)} />
      <TimePickerModal visible={endPickerOpen} value={endTime || "10:00"} onSelect={setEndTime} onClose={() => setEndPickerOpen(false)} />
    </>
  );
}
