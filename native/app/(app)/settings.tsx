...
export default function SettingsScreen() {
  ...
  const connectGmail = async () => {
    try {
      ...
      await WebBrowser.openAuthSessionAsync(url, "calendarai://");
    } catch (e: any) {
      Alert.alert("Error", e.message);
    }
  };
...
const styles = StyleSheet.create({
  ...
  content: { padding: s(24), paddingBottom: s(60) },
  centered: { flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: EARTHY.cream },
  sectionTitle: { fontSize: fontSize(12), fontFamily: FONTS.bodyMedium, color: EARTHY.stone, textTransform: "uppercase", letterSpacing: 0.5, marginTop: s(28), marginBottom: s(6), marginLeft: s(4) },
  helpText: { fontSize: fontSize(13), color: EARTHY.barkSoft, fontFamily: FONTS.bodyLight, marginBottom: s(10), marginLeft: s(4), lineHeight: fontSize(18) },
  helpTextInCard: { fontSize: fontSize(14), color: EARTHY.barkSoft, fontFamily: FONTS.bodyLight, marginBottom: s(12), lineHeight: fontSize(20) },
  card: { backgroundColor: EARTHY.white, borderRadius: s(14), padding: s(16), borderWidth: 1, borderColor: EARTHY.sand },
  label: { fontSize: fontSize(12), color: EARTHY.stone, fontFamily: FONTS.bodyMedium, marginBottom: s(4), marginTop: s(12) },
  input: { borderWidth: 1, borderColor: EARTHY.sand, borderRadius: s(10), padding: s(12), fontSize: fontSize(15), backgroundColor: EARTHY.cream, color: EARTHY.bark, fontFamily: FONTS.body },
  value: { fontSize: fontSize(15), color: EARTHY.bark, fontFamily: FONTS.bodyMedium },
  row: { flexDirection: "row", alignItems: "center", gap: s(8) },
  statusDot: { width: s(8), height: s(8), borderRadius: s(4), backgroundColor: "#86C3B9" },
  saveButton: { backgroundColor: ACCENT, borderRadius: s(12), padding: s(14), alignItems: "center", marginTop: s(16) },
  buttonDisabled: { opacity: 0.5 },
  saveButtonText: { color: EARTHY.white, fontSize: fontSize(15), fontFamily: FONTS.bodyMedium },
  actionButton: { backgroundColor: ACCENT, borderRadius: s(10), padding: s(14), alignItems: "center" },
  actionButtonText: { color: EARTHY.white, fontSize: fontSize(15), fontFamily: FONTS.bodyMedium },
  outlineButton: { borderWidth: 1, borderColor: ACCENT, borderRadius: s(10), padding: s(14), alignItems: "center" },
  outlineButtonText: { color: ACCENT, fontSize: fontSize(15), fontFamily: FONTS.bodyMedium },
  signOutButton: { marginTop: s(40), padding: s(16), alignItems: "center" },
  signOutText: { color: "#EF4444", fontSize: fontSize(15), fontFamily: FONTS.bodyMedium },
  modalOverlay: { flex: 1, backgroundColor: "rgba(59,47,38,0.4)", justifyContent: "flex-end" },
  modalKeyboard: { justifyContent: "flex-end" },
  modalCard: { backgroundColor: EARTHY.white, borderTopLeftRadius: s(24), borderTopRightRadius: s(24), padding: s(24), paddingTop: s(20), paddingBottom: s(40) },
  modalClose: { alignSelf: "flex-end", padding: s(4) },
  modalCloseText: { fontSize: fontSize(18), color: EARTHY.stone },
  resyBadge: { backgroundColor: "#DA3743", borderRadius: s(6), paddingHorizontal: s(12), paddingVertical: s(4), alignSelf: "flex-start", marginBottom: s(16) },
  resyBadgeText: { color: "#FFFFFF", fontSize: fontSize(13), fontFamily: FONTS.bodyMedium, fontWeight: "700", letterSpacing: 1 },
  modalTitle: { fontSize: fontSize(22), fontFamily: FONTS.heading, color: EARTHY.bark, marginBottom: s(12) },
  modalBody: { fontSize: fontSize(14), fontFamily: FONTS.body, color: EARTHY.barkSoft, lineHeight: fontSize(20), marginBottom: s(12) },
  modalLabel: { fontSize: fontSize(12), color: EARTHY.stone, fontFamily: FONTS.bodyMedium, marginBottom: s(4), marginTop: s(8) },
  modalInput: { borderWidth: 1, borderColor: EARTHY.sand, borderRadius: s(10), padding: s(14), fontSize: fontSize(15), backgroundColor: EARTHY.white, color: EARTHY.bark, fontFamily: FONTS.body },
  resyErrorBox: { backgroundColor: "#FEF2F2", borderWidth: 1, borderColor: "#FECACA", borderRadius: s(10), padding: s(12), marginBottom: s(8) },
  resyErrorText: { color: "#991B1B", fontSize: fontSize(13), fontFamily: FONTS.body },
  resySubmitButton: { backgroundColor: "#C0935A", borderRadius: s(12), padding: s(16), alignItems: "center", marginTop: s(20) },
  resySubmitText: { color: "#FFFFFF", fontSize: fontSize(16), fontFamily: FONTS.bodyMedium, fontWeight: "600" },
});
