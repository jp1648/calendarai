...
const styles = StyleSheet.create({
  ...
  signOutText: { color: "#944B43", fontSize: fontSize(15), fontFamily: FONTS.bodyMedium },
  modalOverlay: { flex: 1, backgroundColor: "rgba(1,35,64,0.4)", justifyContent: "flex-end" },
  ...
  resyErrorBox: { backgroundColor: "rgba(140,70,70,0.08)", borderWidth: 1, borderColor: "#8C4646", borderRadius: s(10), padding: s(12), marginBottom: s(8) },
  resyErrorText: { color: "#7A3D3D", fontSize: fontSize(13), fontFamily: FONTS.body },
  resySubmitButton: { backgroundColor: "#8C6046", borderRadius: s(12), padding: s(16), alignItems: "center", marginTop: s(20) },
